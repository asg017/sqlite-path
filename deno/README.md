...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-path@0.2.0-alpha.6/mod.ts)
...
import * as sqlite_path from "https://deno.land/x/sqlite_path@v0.2.0-alpha.6/mod.ts";
